    ...
    return (
        <div>
                                                    ...
                                                    {aCartitem.Status === 0 ?
                                                        (
                                                            <Button style={{ width: "100px" }}
                                                                variant="danger"> Chưa xử lý </Button>

                                                        ) : (aCartitem.Status === 1 ?

                                                            <Button style={{ width: "100px" }}
                                                                variant="danger"> Đang xử lý </Button>

                                                            : (aCartitem.Status === 2 ?
                                                                <Button style={{ width: "100px" }}
                                                                    onClick={(e) => ShowModalHandler(e, aCartitem.id)}
                                                                    variant="danger"> Xác nhận</Button>
                                                                :
                                                                <Button style={{ width: "100px" }}

                                                                    variant="success"> Đã giao</Button>
                                                            )
                                                        )
                                                    }
                                                </td>
            ...
            <Modal show={modalshow}
                ...
                <Modal.Body>
                    Xác nhận Giao hàng và thanh toán thành công !
                </Modal.Body>
                <Modal.Footer>
...
export default HandleCartItemShip;